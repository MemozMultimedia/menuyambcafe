...
# --- CSS Avanzado para Organización de Tarjetas ---
st.markdown("""<style>
    ...
    .product-card {
        ...
        margin-bottom: 10px; overflow: hidden; border: 1px solid #eee;
    ...
    .product-title { font-weight: 800; font-size: 1.1rem; margin-bottom: 8px; color: #1e1e1e; }
    .product-price { color: #e63946 !important; font-weight: 800; font-size: 1.2rem; margin-bottom: 15px; }

    .selector-container {
        background: #f8f9fa; border-top: 1px solid #eee; padding: 12px;
    }
    ...
    .stButton > button {
        border-radius: 10px !important; border: 1px solid #ddd !important; background: white !important; color: black !important;
    }

    .qty-text { text-align: center; font-weight: 800; font-size: 1.2rem; margin: 0; color: #1e1e1e !important; }

    .footer-premium { padding: 40px 20px; border-radius: 40px 40px 0 0; margin-top: 40px; text-align: center; background: #f9f9f9; border-top: 1px solid #eee; }
